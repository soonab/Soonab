export default async function SettingsPage() {
  return (
    <main className="mx-auto max-w-xl p-6 space-y-4">
      ...
      <form action="/api/account/delete" method="POST" onSubmit={() => confirm('Soft-delete your profile?')}>
        <button className="rounded border px-3 py-1">Delete my profile</button>
      </form>
